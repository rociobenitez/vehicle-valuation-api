...
// Obtener las marcas desde la API (helper PHP). Se convierte a JSON por si se quisiera usar
// desde JS inline. En la implementación actual el JS hace llamadas AJAX, por lo que esta
// variable es opcional pero queda documentada aquí.
$marcas = obtener_datos_api_autobiz('referential/v1/makes');
$marcas_json = !empty($marcas) ? json_encode($marcas) : '[]';
